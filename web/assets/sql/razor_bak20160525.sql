...
) ENGINE=InnoDB AUTO_INCREMENT=31704 DEFAULT CHARSET=utf8;
...
CREATE TABLE `razor_createrole` (
  ...
  `chId` varchar(8) NOT NULL COMMENT '渠道编号',
  `subSrvId` varchar(8) DEFAULT NULL COMMENT '合区区服编号',
  `srvId` varchar(8) DEFAULT NULL COMMENT '区服编号',
  `appId` varchar(8) NOT NULL COMMENT '应用编号',
  `version` varchar(32) NOT NULL COMMENT '版本号',
  `obligate1` varchar(64) DEFAULT NULL COMMENT '预留字段一',
  `obligate2` varchar(64) DEFAULT NULL COMMENT '预留字段二',
  `obligate3` varchar(64) DEFAULT NULL COMMENT '预留字段三',
  `obligate4` varchar(64) DEFAULT NULL COMMENT '预留字段四',
  `obligate5` varchar(64) DEFAULT NULL COMMENT '预留字段五',
  `obligate6` varchar(64) DEFAULT NULL COMMENT '预留字段六',
  `userId` varchar(64) NOT NULL COMMENT 'Razor用户编号',
  `productkey` varchar(64) NOT NULL COMMENT '应用key值',
  `deviceid` varchar(64) NOT NULL COMMENT '设备编号',
  `create_role_time` datetime NOT NULL COMMENT '玩家角色创建时间',
  `roleId` varchar(64) NOT NULL COMMENT '玩家角色编号',
  `roleName` varchar(255) NOT NULL COMMENT '玩家角色名称',
  `roleLevel` int(8) NOT NULL COMMENT '玩家角色等级',
  `roleSex` varchar(8) DEFAULT NULL COMMENT '玩家角色性别',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`create_role_time`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=34560 DEFAULT CHARSET=utf8;
...
CREATE TABLE `razor_deviceboot` (
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`version`,`deviceid`,`deviceboot_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `server` (`chId`,`appId`,`version`) USING BTREE,
  KEY `deviceboot_date` (`deviceboot_date`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11736 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_errorcode` (
  ...
  `chId` varchar(8) NOT NULL COMMENT '渠道编号。由Razor管理员提供',
  `subSrvId` varchar(8) DEFAULT NULL COMMENT '合区区服编号。由Razor管理员提供',
  `srvId` varchar(8) NOT NULL COMMENT '区服编号。由Razor管理员提供',
  `appId` varchar(8) NOT NULL COMMENT '产品ID。由Razor管理员提供',
  `version` varchar(32) NOT NULL COMMENT '版本号',
  `errorcodeid` varchar(16) NOT NULL COMMENT '错误码id',
  `aciontid` varchar(16) NOT NULL COMMENT '行为id',
  `functionid` varchar(16) NOT NULL COMMENT '功能ID。例如：如：100002表示：神位争霸',
  `userId` varchar(64) NOT NULL COMMENT '玩家用户ID',
  `productkey` varchar(64) NOT NULL COMMENT '应用key值。由Razor管理员提供',
  `deviceid` varchar(64) NOT NULL COMMENT '设备编号',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`errorcodeid`,`aciontid`,`functionid`,`errorcode_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `roleid` (`roleId`) USING BTREE,
  KEY `server` (`chId`,`srvId`,`appId`,`version`) USING BTREE,
...
CREATE TABLE `razor_experiencevariation` (
  ...
  `appId` varchar(8) NOT NULL COMMENT '产品ID。由Razor管理员提供',
  `version` varchar(32) NOT NULL COMMENT '版本号',
  `actionid` varchar(16) NOT NULL COMMENT '行为id',
  `experience` varchar(32) NOT NULL COMMENT '经验数',
  `userId` varchar(64) NOT NULL COMMENT '玩家用户ID',
  `productkey` varchar(64) NOT NULL COMMENT '应用key值。由Razor管理员提供',
  `deviceid` varchar(64) NOT NULL COMMENT '设备编号',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`actionid`,`experience`,`experiencevariation_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `roleid` (`roleId`) USING BTREE,
  KEY `server` (`chId`,`srvId`,`appId`,`version`) USING BTREE,
...
CREATE TABLE `razor_functioncount` (
  ...
  `appId` varchar(8) NOT NULL COMMENT '产品ID。由Razor管理员提供',
  `version` varchar(32) NOT NULL COMMENT '版本号',
  `eventid` varchar(16) NOT NULL COMMENT '事件id',
  `issue` varchar(16) NOT NULL COMMENT '活动期号',
  `functionid` varchar(16) NOT NULL COMMENT '功能ID。例如：如：100002表示：神位争霸',
  `userId` varchar(64) NOT NULL COMMENT '玩家用户ID',
  `productkey` varchar(64) NOT NULL COMMENT '应用key值。由Razor管理员提供',
  `deviceid` varchar(64) NOT NULL COMMENT '设备编号',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`eventid`,`issue`,`functionid`,`functioncount_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `functioncount_date` (`functioncount_date`,`appId`,`chId`,`srvId`,`version`) USING BTREE,
  KEY `functionid` (`functionid`) USING BTREE,
  KEY `functioneventid` (`functionid`,`eventid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=238918 DEFAULT CHARSET=utf8;
...
CREATE TABLE `razor_install` (
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`version`,`deviceid`,`install_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `server` (`chId`,`appId`,`version`) USING BTREE,
...
CREATE TABLE `razor_levelupgrade` (
  ...
  `chId` varchar(8) NOT NULL COMMENT '渠道编号',
  `subSrvId` varchar(8) DEFAULT NULL COMMENT '合区区服编号',
  `srvId` varchar(8) NOT NULL COMMENT '区服编号',
  `appId` varchar(8) NOT NULL COMMENT '应用编号',
  `version` varchar(32) NOT NULL COMMENT '版本号',
  `userId` varchar(64) NOT NULL COMMENT 'Razor用户编号',
  `productkey` varchar(64) NOT NULL COMMENT '应用key值',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`roleLevel`,`levelupgrade_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  ...
  KEY `roleId` (`roleId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=26981 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_login` (
  ...
  `obligate1` varchar(64) DEFAULT NULL COMMENT '预留字段一',
  `obligate2` varchar(64) DEFAULT NULL COMMENT '预留字段一',
  `obligate3` varchar(64) DEFAULT NULL COMMENT '预留字段一',
  `obligate4` varchar(64) DEFAULT NULL COMMENT '预留字段一',
  `userId` varchar(64) NOT NULL COMMENT 'Razor用户编号',
  `roleId` varchar(64) NOT NULL COMMENT '玩家角色编号',
  `roleLevel` int(8) NOT NULL COMMENT '玩家角色等级',
  `roleVip` int(8) DEFAULT NULL COMMENT '玩家角色VIP等级',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`login_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `roleid` (`roleId`) USING BTREE,
  KEY `deviceid` (`deviceid`) USING BTREE,
  ...
  KEY `server` (`chId`,`srvId`,`appId`,`version`) USING BTREE,
  KEY `userId` (`userId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=205418 DEFAULT CHARSET=utf8;
...
CREATE TABLE `razor_mainconfig_action` (
  ...
  `action_desc` varchar(1024) DEFAULT NULL COMMENT '行为描述',
  PRIMARY KEY (`id`),
  UNIQUE KEY `app_action_id` (`app_id`,`action_id`) USING BTREE,
  KEY `action_id` (`action_id`) USING BTREE,
  KEY `app_id` (`app_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5392 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_mainconfig_actiontype` (
  ...
  KEY `app_id` (`app_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=395 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=3373 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_mainconfig_mainlinetask` (
  ...
  UNIQUE KEY `app_task_step_id` (`app_id`,`task_id`,`step_id`) USING BTREE,
  KEY `app_id` (`app_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4369 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_mainconfig_prop` (
  ...
  KEY `app_id` (`app_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=18974 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_mainconfig_tollgate` (
  ...
  KEY `app_id` (`app_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11445 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_newuserguide` (
  ...
  `appId` varchar(8) NOT NULL COMMENT '产品ID。由Razor管理员提供',
  `version` varchar(32) NOT NULL COMMENT '版本号',
  `newuserguide_id` varchar(16) NOT NULL COMMENT '新手引导id',
  `stepid` varchar(8) NOT NULL COMMENT '新手引导步骤id',
  `userId` varchar(64) NOT NULL COMMENT '玩家用户ID',
  `markid` varchar(8) DEFAULT NULL,
  `productkey` varchar(64) NOT NULL COMMENT '应用key值。由Razor管理员提供',
  `deviceid` varchar(64) NOT NULL COMMENT '设备编号',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`newuserguide_id`,`stepid`,`markid`,`newuserguide_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `roleid` (`roleId`) USING BTREE,
  KEY `server` (`chId`,`srvId`,`appId`,`version`) USING BTREE,
  KEY `newuserguide_date` (`newuserguide_date`) USING BTREE,
  KEY `newuserguide_id` (`newuserguide_id`) USING BTREE,
  KEY `stepid` (`stepid`) USING BTREE,
  KEY `newuserguidestepid` (`newuserguide_id`,`stepid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=28547 DEFAULT CHARSET=utf8;
...
CREATE TABLE `razor_newuserprogress` (
  ...
  `appId` varchar(8) NOT NULL COMMENT '产品ID。由Razor管理员提供',
  `version` varchar(32) NOT NULL COMMENT '版本号',
  `newuserprogressid` varchar(16) NOT NULL COMMENT '新用户进度id',
  `stepid` varchar(8) NOT NULL COMMENT '步骤id。1开始',
  `userId` varchar(64) NOT NULL COMMENT '玩家用户ID',
  `productkey` varchar(64) NOT NULL COMMENT '应用key值。由Razor管理员提供',
  `deviceid` varchar(64) NOT NULL COMMENT '设备编号',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`newuserprogressid`,`stepid`,`newuserprogress_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `roleid` (`roleId`) USING BTREE,
  KEY `server` (`chId`,`srvId`,`appId`,`version`) USING BTREE,
...
CREATE TABLE `razor_pay` (
  ...
  `orderId` varchar(128) NOT NULL COMMENT '支付订单编号',
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`userId`,`roleId`,`pay_time`,`orderId`,`pay_amount`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `roleid` (`roleId`) USING BTREE,
  KEY `server` (`chId`,`srvId`,`appId`,`version`) USING BTREE,
...
CREATE TABLE `razor_propconsume` (
  ...
  `version` varchar(32) NOT NULL COMMENT '版本号',
  `actionid` varchar(16) NOT NULL COMMENT '行为id',
  `propid` varchar(16) NOT NULL COMMENT '道具id',
  ...
  `functionid` varchar(16) NOT NULL COMMENT '功能ID。例如：如：100002 表示：神位争霸。',
  `acionttypeid` varchar(8) NOT NULL COMMENT '行为类型ID。例如：如：003 表示：功能产出。',
  `userId` varchar(64) NOT NULL COMMENT '玩家用户ID',
  `productkey` varchar(64) NOT NULL COMMENT '应用key值。由Razor管理员提供',
  `deviceid` varchar(64) NOT NULL COMMENT '设备编号',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`actionid`,`propid`,`proplevel`,`propconsume_count`,`prop_stock`,`functionid`,`acionttypeid`,`propconsume_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `roleid` (`roleId`) USING BTREE,
  KEY `server` (`chId`,`srvId`,`appId`,`version`) USING BTREE,
  KEY `propconsume_date` (`propconsume_date`) USING BTREE,
  KEY `actionid` (`actionid`) USING BTREE,
  KEY `propid` (`propid`) USING BTREE,
  KEY `functionid` (`functionid`) USING BTREE,
  KEY `functionpropactionid` (`functionid`,`propid`,`actionid`) USING BTREE,
  KEY `functionpropid` (`functionid`,`propid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=60627 DEFAULT CHARSET=utf8;
...
CREATE TABLE `razor_propertyvariation` (
  ...
  `version` varchar(32) NOT NULL COMMENT '版本号',
  `actionid` varchar(16) NOT NULL COMMENT '行为id',
  `property` varchar(32) NOT NULL COMMENT '属性。体力贡献值等等',
  ...
  `functionid` varchar(16) NOT NULL COMMENT '功能ID。例如：如：100002 表示：神位争霸。',
  `acionttypeid` varchar(8) NOT NULL COMMENT '行为类型ID。例如：如：003 表示：功能加。 006 表示：功能减',
  `userId` varchar(64) NOT NULL COMMENT '玩家用户ID',
  `productkey` varchar(64) NOT NULL COMMENT '应用key值。由Razor管理员提供',
  `deviceid` varchar(64) NOT NULL COMMENT '设备编号',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`actionid`,`property`,`property_variation`,`count`,`stock`,`functionid`,`acionttypeid`,`propertyvariation_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `propertyvariation_date` (`propertyvariation_date`,`chId`,`srvId`,`appId`,`version`) USING BTREE,
  KEY `functionid` (`functionid`) USING BTREE,
  KEY `property` (`property`,`property_variation`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=91834 DEFAULT CHARSET=utf8;
...
CREATE TABLE `razor_propgain` (
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`actionid`,`propid`,`proplevel`,`propgain_count`,`prop_stock`,`functionid`,`acionttypeid`,`propgain_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `propgain_date` (`propgain_date`,`chId`,`srvId`,`appId`,`version`) USING BTREE,
  KEY `propid` (`propid`) USING BTREE,
  KEY `actionid` (`actionid`) USING BTREE,
  KEY `functionid` (`functionid`) USING BTREE,
  KEY `functionpropactionid` (`functionid`,`propid`,`actionid`) USING BTREE,
  KEY `functionpropid` (`functionid`,`propid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=93236 DEFAULT CHARSET=utf8;
...
CREATE TABLE `razor_realtimeonlineusers` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`count_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `server` (`chId`,`srvId`,`appId`,`version`) USING BTREE,
  KEY `count_date` (`count_date`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=231532 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_register` (
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`version`,`userId`,`register_time`) USING BTREE,
  UNIQUE KEY `idx_userid` (`userId`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `register_date` (`register_date`) USING BTREE,
  KEY `server` (`chId`,`appId`,`version`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=28178 DEFAULT CHARSET=utf8;
...
CREATE TABLE `razor_task` (
  ...
  `appId` varchar(8) NOT NULL COMMENT '产品ID。由Razor管理员提供',
  `version` varchar(32) NOT NULL COMMENT '版本号',
  `taskid` varchar(16) NOT NULL COMMENT '任务id',
  `stepid` varchar(8) NOT NULL COMMENT '步骤id。1开始',
  `markid` varchar(8) NOT NULL COMMENT '标识id。最后一步发1，非最后一步发0',
  `userId` varchar(64) NOT NULL COMMENT '玩家用户ID',
  `productkey` varchar(64) NOT NULL COMMENT '应用key值。由Razor管理员提供',
  `deviceid` varchar(64) NOT NULL COMMENT '设备编号',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`taskid`,`stepid`,`markid`,`task_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `roleid` (`roleId`) USING BTREE,
  KEY `task_date` (`task_date`) USING BTREE,
  KEY `taskid` (`taskid`) USING BTREE,
  KEY `stepid` (`stepid`) USING BTREE,
  KEY `taskstepid` (`taskid`,`stepid`) USING BTREE,
  KEY `idx_tacsvid` (`task_date`,`appId`,`chId`,`srvId`,`version`) USING BTREE,
  KEY `markid` (`markid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1049086 DEFAULT CHARSET=utf8;
...
CREATE TABLE `razor_tollgate` (
  ...
  `appId` varchar(8) NOT NULL COMMENT '产品ID。由Razor管理员提供',
  `version` varchar(32) NOT NULL COMMENT '版本号',
  `moduleid` varchar(16) NOT NULL COMMENT '关卡大类id',
  `tollgateid` varchar(16) NOT NULL COMMENT '关卡id',
  `tollgategrade` int(16) NOT NULL DEFAULT '0' COMMENT '关卡',
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`moduleid`,`tollgateid`,`tollgategrade`,`tollgatesweep`,`pass`,`passtime`,`combattimeout`,`tollgate_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
  KEY `roleid` (`roleId`) USING BTREE,
  KEY `server` (`chId`,`srvId`,`appId`,`version`) USING BTREE,
  KEY `tollgate_date` (`tollgate_date`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=23923 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for razor_user_permissions_item
-- ----------------------------
DROP TABLE IF EXISTS `razor_user_permissions_item`;
CREATE TABLE `razor_user_permissions_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role` int(11) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for razor_user_resources_item
-- ----------------------------
DROP TABLE IF EXISTS `razor_user_resources_item`;
CREATE TABLE `razor_user_resources_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `classify` int(11) DEFAULT NULL,
  `classifname` varchar(255) DEFAULT NULL,
...
CREATE TABLE `razor_viplevelup` (
  ...
  `insertdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '入库时间',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idx_id` (`appId`,`chId`,`srvId`,`version`,`roleId`,`currentRoleVip`,`viplevelup_time`) USING BTREE,
  KEY `insertdate` (`insertdate`) USING BTREE,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `VIEW_razor_pay_count` AS select `p`.`roleId` AS `roleId`,count(1) AS `pay_count` from `razor_pay` `p` group by `p`.`roleId` order by count(1) desc ;

-- ----------------------------
-- View structure for VIEW_razor_pay_logintimes
-- ----------------------------
DROP VIEW IF EXISTS `VIEW_razor_pay_logintimes`;
CREATE ALGORITHM=UNDEFINED DEFINER=`razor`@`%` SQL SECURITY DEFINER VIEW `VIEW_razor_pay_logintimes` AS select `l`.`login_date` AS `login_date`,`l`.`appId` AS `appId`,`l`.`chId` AS `chId`,`l`.`srvId` AS `srvId`,`l`.`version` AS `version`,`l`.`userId` AS `userId`,count(1) AS `logintimes` from `razor_login` `l` where `l`.`userId` in (select distinct `p`.`userId` from `razor_pay` `p`) group by `l`.`login_date`,`l`.`appId`,`l`.`chId`,`l`.`srvId`,`l`.`version`,`l`.`userId` ;
