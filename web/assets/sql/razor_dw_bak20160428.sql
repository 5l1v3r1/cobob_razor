...
) ENGINE=InnoDB AUTO_INCREMENT=1961 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_borderintervaltime` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=24252 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_customremain_daily` (
  ...
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=529278 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_customremain_monthly` (
  ...
  KEY `logintimes` (`logintimes`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8086 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_customremain_weekly` (
  ...
  KEY `logintimes` (`logintimes`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=207610 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_dayonline` (
  ...
  `ccu` decimal(11,4) NOT NULL COMMENT '（ACU/PCU）CCU比率',
  PRIMARY KEY (`rid`),
  UNIQUE KEY `productid` (`startdate_sk`,`enddate_sk`,`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE,
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2924 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=59044 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_errorcodeanaly` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3585 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_firstpayanaly_amount` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=19406 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_firstpayanaly_level` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=24620 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_firstpayanaly_time` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=34046 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_frequencytime_countday` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=161310 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_frequencytime_gametime` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=110374 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_frequencytime_timefield` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=142628 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_leavecount` (
  ...
  KEY `date` (`date_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=103470 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_leavecount_levelaly` (
  ...
  KEY `date` (`date_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=436742 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_levelanaly` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=122372 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_levelanaly_totalupgradetime` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=281601 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_levelleave` (
  ...
  `avgupdatetime` varchar(128) NOT NULL COMMENT '平均升级时长',
  PRIMARY KEY (`rid`),
  UNIQUE KEY `id` (`date_sk`,`product_id`,`version_name`,`channel_name`,`server_name`,`rolelevel`) USING BTREE,
  KEY `date` (`date_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=125512 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_newpay` (
  ...
  KEY `date` (`date_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=54066 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_newuserprogress` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=192801 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_payanaly_arpu_daily` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2784 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_payanaly_paycount` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=49774 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=26980 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_payinterval_first` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=40200 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_payinterval_second` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=38600 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_payinterval_third` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=38300 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_paylevel` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=134672 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_payrate_daily` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3804 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_payrate_weekly` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2014 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=20713 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_sa_function` (
  ...
  `function_goldoutput` int(11) NOT NULL COMMENT '金币产出',
  `function_goldoutputrate` decimal(11,4) NOT NULL COMMENT '金币产出占比',
  `function_goldconsume` int(11) NOT NULL COMMENT '金币消耗',
  `function_goldconsumerate` decimal(11,4) NOT NULL COMMENT '金币消耗占比',
  `function_sliveroutput` int(11) NOT NULL COMMENT '银币产出',
  `function_sliveroutputrate` decimal(11,4) NOT NULL COMMENT '银币产出占比',
  `function_sliverconsume` int(11) NOT NULL COMMENT '银币消耗',
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=25456 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_sa_function_behaviour` (
  ...
  `function` varchar(128) NOT NULL COMMENT '功能',
  `prop_id` varchar(128) NOT NULL COMMENT '道具ID',
  `behaviour_id` varchar(128) NOT NULL COMMENT '行为ID',
  `behaviour_name` varchar(128) NOT NULL COMMENT '行为名',
  `behaviour_gaincount` int(11) NOT NULL,
  `behaviour_gainrate` decimal(11,4) NOT NULL COMMENT '占比',
  `behaviour_consumecount` int(11) NOT NULL,
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=192738 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_sa_function_prop` (
  ...
  `prop_id` varchar(128) NOT NULL COMMENT '道具ID/行为ID',
  `prop_name` varchar(128) NOT NULL COMMENT '道具名/行为名',
  `prop_type` varchar(128) NOT NULL COMMENT '道具类型',
  `prop_count` int(11) NOT NULL COMMENT '道具产出、消耗数量/行为次',
  PRIMARY KEY (`rid`),
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=333136 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_sa_taskanalysis_step` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=544668 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_sa_taskanalysis_task` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=388064 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_sa_tollgateanalysis_big` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7258 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_sa_tollgateanalysis_small` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=521190 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Table structure for razor_sum_basic_sa_tollgateanalysis_smalldetail_bak20160317
-- ----------------------------
DROP TABLE IF EXISTS `razor_sum_basic_sa_tollgateanalysis_smalldetail_bak20160317`;
CREATE TABLE `razor_sum_basic_sa_tollgateanalysis_smalldetail_bak20160317` (
  `rid` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `startdate_sk` date NOT NULL COMMENT '开始日期编号',
  `enddate_sk` date NOT NULL COMMENT '结束日期编号',
  `product_id` int(11) NOT NULL COMMENT '产品ID',
  ...
  `server_name` varchar(128) NOT NULL COMMENT '区服名称',
  `tollgate_bigcategory` varchar(128) NOT NULL COMMENT '关卡大类',
  `tollgate_id` varchar(128) NOT NULL COMMENT '小关卡id',
  `tollgate_attackcount` int(11) NOT NULL COMMENT '攻打次数',
  `tollgate_successcount` int(11) NOT NULL COMMENT '胜利次数',
  `tollgate_failcount` int(11) NOT NULL COMMENT '失败次数',
  `tollgate_successrate` decimal(11,4) NOT NULL COMMENT '胜率',
  ...
  `tollgate_sweepuser` int(11) NOT NULL COMMENT '扫荡人数',
  PRIMARY KEY (`rid`),
  UNIQUE KEY `startdate_sk` (`startdate_sk`,`enddate_sk`,`product_id`,`version_name`,`channel_name`,`server_name`,`tollgate_bigcategory`,`tollgate_id`) USING BTREE,
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_sa_virtualmoney` (
  ...
  `server_name` varchar(128) NOT NULL COMMENT '区服名称',
  `virtualmoney` varchar(128) NOT NULL COMMENT '虚拟币',
  `virtualmoney_output` int(11) NOT NULL COMMENT '产出+',
  `virtualmoney_consume` int(11) NOT NULL COMMENT '消耗-',
  `virtualmoney_outputuser` int(11) NOT NULL COMMENT '产出角色',
  `virtualmoney_consumeuser` int(11) NOT NULL COMMENT '消耗角色',
  PRIMARY KEY (`rid`),
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10896 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_sa_virtualmoney_outputway` (
  ...
  `virtualmoney_outputrate` decimal(11,4) NOT NULL COMMENT '产出占比',
  PRIMARY KEY (`rid`),
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=50696 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_start_login_peoplesbycount` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=15238 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_start_login_times` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2250 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_time_count_avg` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10834 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_userltv` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7593 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_userltv_timefield` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=690806 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_userremain_daily` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=61566 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_vipremain` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3065 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_viprole_leavealany` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3083 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `razor_sum_basic_viprole_leavealany_userlevel` (
  ...
  KEY `startdate` (`startdate_sk`) USING BTREE,
  KEY `server` (`product_id`,`version_name`,`channel_name`,`server_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=246467 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
