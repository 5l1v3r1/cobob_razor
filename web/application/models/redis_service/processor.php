    ...
    function process()
    {
        ...
        if ($timestamp != null && $timestamp != "") {
            ...
            if ($timeDiffer > $timeInterval) {
                ...
                //new add
                $this -> processItems("razor_createrole", "createrole", "productkey");
                $this -> processItems("razor_install", "install", "productkey");
                $this -> processItems("razor_login", "login", "productkey");
                $this -> processItems("razor_pay", "pay", "productkey");
                $this -> processItems("razor_register", "register", "productkey");
