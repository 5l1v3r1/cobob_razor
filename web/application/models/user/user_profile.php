...
class User_profile extends CI_Model
{
     ...
     * @return query
     */
    public function getUserPorfile($uerid)
    {
     ...
     * @return void
     */
    public function addUserPorfile($userId, $username, $companyname, $contact, $telephone, $QQ, $MSN, $Gtalk)
    {
    ...
    {
        $sql = "delete from razor_login_attempts;";
