...
class Borderintervaltimemodel extends CI_Model {
    ...
    function sum_basic_borderintervaltime($countdate) {
        ...
        for ($i = 0; $i < $params_psv->num_rows(); $i++) {
            $rolecount_min_0_60=$this->getRolecount($countdate, $paramsRow_psv->appId, 'all', $paramsRow_psv->srvId, $paramsRow_psv->version,0,0);
        ...
        for ($i = 0; $i < $params_ps->num_rows(); $i++) {
            $rolecount_min_0_60=$this->getRolecount($countdate, $paramsRow_ps->appId, 'all', $paramsRow_ps->srvId, 'all',0,0);
        ...
        for ($i = 0; $i < $params_pv->num_rows(); $i++) {
            $rolecount_min_0_60=$this->getRolecount($countdate, $paramsRow_pv->appId, 'all', 'all', $paramsRow_pv->version,0,0);
        ...
        for ($i = 0; $i < $params_p->num_rows(); $i++) {
            $rolecount_min_0_60=$this->getRolecount($countdate, $paramsRow_p->appId, 'all', 'all', 'all',0,0);
        ...
        for ($i = 0; $i < $params_pcsv->num_rows(); $i++) {
            $rolecount_min_0_60=$this->getRolecount($countdate, $paramsRow_pcsv->appId, $paramsRow_pcsv->chId, $paramsRow_pcsv->srvId, $paramsRow_pcsv->version,0,0);
        ...
        for ($i = 0; $i < $params_pcs->num_rows(); $i++) {
            $rolecount_min_0_60=$this->getRolecount($countdate, $paramsRow_pcs->appId, $paramsRow_pcs->chId, $paramsRow_pcs->srvId, 'all',0,0);
        ...
        for ($i = 0; $i < $params_pcv->num_rows(); $i++) {
            $rolecount_min_0_60=$this->getRolecount($countdate, $paramsRow_pcv->appId, $paramsRow_pcv->chId, 'all', $paramsRow_pcv->version,0,0);
        ...
        for ($i = 0; $i < $params_pc->num_rows(); $i++) {
            $rolecount_min_0_60=$this->getRolecount($countdate, $paramsRow_pc->appId, $paramsRow_pc->chId, 'all', 'all',0,0);
