...
class Productbasic extends CI_Controller
{
    ...
    function view($productId = 0) 
    {
        ...
        if (isset($_GET['type']) && 'compare' == $_GET['type']) {
            //get the current product info from the session
        ...
        //check user's permission to current product
        ...
        if ($currentProduct != null) {
            if (!empty($productId)) {
                ...
                //let current product id save to _data[] array
        ...
        redirect(site_url().'/seeall/realtimeinfo/index');
