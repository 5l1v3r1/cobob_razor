...
class Ums extends CI_Controller {
    ...
    /**
     * Interface to accept createrole data
     *
     * @return void
     */
    function postCreateroleData() {
        ...
        if ($ret == null) {
            try {
                $this->load->model($this->_prefix . '/createrole', 'createrole');
                $this->createrole->addCreaterole($this->_jsondata);
                $ret = array(
                    'flag' => 1,
                    'msg' => 'ok'
                );
    ...
    /**
     * Interface to accept install data
     *
     * @return void
     */
    function postInstallData() {
        $ret = $this->_checkJsonData();
        if ($ret == null) {
            try {
                $this->load->model($this->_prefix . '/install', 'install');
                $this->install->addInstallData($this->_jsondata);
                $ret = array(
                    'flag' => 1,
                    'msg' => 'ok'
                );
    ...
    /**
     * Interface to accept login data
     *
     * @return void
     */
    function postLoginData() {
        ...
        if ($ret == null) {
            try {
                $this->load->model($this->_prefix . '/login', 'login');
                $this->login->addLoginData($this->_jsondata);
                $ret = array(
                    'flag' => 1,
                    'msg' => 'ok'
                );
    ...
    function postPayData() {
        ...
        if ($ret == null) {
            try {
                $this->load->model($this->_prefix . '/pay', 'pay');
                $this->pay->addPayData($this->_jsondata);
                $ret = array(
                    'flag' => 1,
                    'msg' => 'ok'
                );
    ...
    /**
     * Interface to accept register data
     *
     * @return void
     */
    function postRegisterData() {
        ...
        if ($ret == null) {
            try {
                $this->load->model($this->_prefix . '/register', 'register');
                $this->register->addRegisterData($this->_jsondata);
                $ret = array(
                    'flag' => 1,
                    'msg' => 'ok'
                );
