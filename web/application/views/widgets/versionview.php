...
if (isset($add)) {
    ...
    <?php
     ...
     <?php echo  lang('v_rpt_ve_changingTrends')?></h3>
            <ul class="tabs2">
                <li><a
                    href="javascript:changeChartType('<?php echo  lang('t_newUsers')?>')"><?php echo  lang('t_newUsers')?></a></li>
                <li><a
                    href="javascript:changeChartType('<?php echo  lang('t_activeUsers')?>')"><?php echo  lang('t_activeUsers')?></a></li>
            </ul>
        </header>
        <!-- 图表 -->
