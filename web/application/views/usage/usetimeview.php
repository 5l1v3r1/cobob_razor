<section id="main" class="column" style="height:800px">
  ...
  <div style="height:470px;">
		<iframe src="<?php echo site_url() ?>/report/usetime/addusadgedurationreport"  frameborder="0" scrolling="no"style="width:100%;height:100%;"></iframe>		
  </div>
  ...
  <article class="module width_full">
		<header>
			...
			<span class="relative r" id="export"> <a
				href="<?php echo site_url()?>/report/usetime/exportCompareUsetime" class="bottun4 hover"><font><?php echo  lang('g_exportToCSV')?></font></a>
			</span>	
			</header>
		...
		<table class="tablesorter" cellspacing="0"> 
			<thead><?php  if(isset($comparetitlecontent)){?>
			    <tr>
			      ...
			      <th width="11%"><?php echo $row['segment_name']?></th><?php } ?>
			    </tr> <?php } ?>
			</thead>
