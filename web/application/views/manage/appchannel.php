<section id="main" class="column">
    ...
    <article class="module width_full">
        <header>
            <h3 class="tabs_involved"><?php echo lang('m_rpt_appChannel') ?></h3>
           <!--  <ul class="tabs">
        ...
        <div class="tab_container">
            <div id="tab3" class="tab_content">
                <header>
                    <h3 align="left"><?php echo lang('v_man_ch_unOpenedChannel') ?></h3>
                </header>
...
foreach ($sychannel as $ret) {
            ...
            <?php
                ...
                <footer></footer>
                <header>
                    <h3 align="left"><?php echo lang('v_man_ch_openedChannel') ?></h3>
                </header>
                <table class="tablesorter" cellspacing="0">
                    <thead>
                        <tr>
            ...
            ?>
                <tr>
                  ...
                  <?php  echo lang('v_man_ch_opened') ?>                 
                            ...
                            <td><a
                                href="<?php echo site_url();?>/manage/autoupdate/index/<?php echo $rel['cp_id']; ?>/<?php echo $rel['channel_id'];?>">
                                    <input type="button"
                                    value="<?php echo lang('v_man_ch_autoUpdate') ?>"
                                    class="alt_btn" onClick=''>
                            </a></td>
                        </tr> 
            <?php 
} endif;?>            
...
foreach ($channel as $rew) {
            ?>
                <tr>
                            ...
                            <td><a
                                href="javascript:if(confirm('<?php echo lang('v_man_pr_openApp') ?>'))location='<?php echo site_url();?>/manage/channel/openchannel/<?php echo $rew['channel_id']; ?>'">
                                    <img src="<?php echo base_url();?>assets/images/turnon.png"
                                    title="Edit" style="border: 0px;" />
                            </a></td>
                        </tr> 
            ...
            ?>
                <tr>
                 ...
                 <?php echo  lang('v_man_ch_opened');?></td>
                            <td><a
                                href="<?php echo site_url();?>/manage/autoupdate/index/<?php echo $row['cp_id']; ?>/<?php echo $row['channel_id'];?>">
                                    <input type="button"
                                    value="<?php echo lang('v_man_ch_autoUpdate') ?>"
                                    class="alt_btn" onClick=''>
                            </a></td>
