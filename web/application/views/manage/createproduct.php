...
foreach ($category->result() as $row) {
    ...
    if (isset($selectcategory) && $selectcategory == $row->id) {
                        echo "Selected";
    }
...
foreach ($platform as $rel) {
                ?>
                    <option value="<?php echo $rel['id']; ?>"
						<?php
                
    if (isset($selectplatform) && $selectplatform == $rel['id']) {
                    echo "Selected";
    }
                ?>><?php echo $rel['name'];?></option>
            <?php
}
         endif;
        ?>        
...
/*
    **2016/3/22 edit by danny
    **添加游戏时 默认 游戏类型->游戏 |  平台->Android
    **并隐藏
*/
...
var platformvalue="<?php

if (isset($selectplatform) && $selectchannel != "") {
    echo $selectplatform;
} else {
    echo "";
}
?>";
var channelvalue="<?php

if (isset($selectchannel) && $selectchannel != "") {
    echo $selectchannel;
} else {
    echo "";
}
