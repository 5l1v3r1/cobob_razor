<section id="main" class="column" style="height: 1100px">
    ...
    <div style="height:480px;">
        <iframe src="<?php echo site_url() ?>/report/resolution/addresolutioninforeport" frameborder="0" scrolling="no"
    ...
    <article class="module width_full">
        <header>
            ...
            <span class="relative r"> <a
                    href="<?php echo site_url() ?>/report/resolution/export"
        ...
        <table class="tablesorter" cellspacing="0">
            ...
            <tr>
                <!-- 分辨率 -->
                <th><?php echo lang('v_rpt_re_screen') ?></th>
                <!-- 启动次数 -->
...
<script type="text/javascript">
    ...
    function pageselectCallback(page_index, jq) 
    {
        ...
        for (i = 0; i < pagenum && (index + i) < detailObj.length; i++) {
            msg = msg + "<tr><td>";
            if (detailObj[i + index].deviceresolution_name.length < 1)
                detailObj[i + index].deviceresolution_name = 'unknown';
            msg = msg + detailObj[i + index].deviceresolution_name;
            msg = msg + "</td><td>";
