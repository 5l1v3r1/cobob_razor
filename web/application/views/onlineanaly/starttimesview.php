...
<section id="main" class="column">
	<article class="module width_full">
		<header>
			<h3 class="tabs_involved"><?php echo  lang('t_sessions')?></h3>
		</header>
		<div class="echarts">
			<iframe src="<?php echo site_url() ?>/onlineanaly/starttimes/charts"  frameborder="0" scrolling="no" style="width:100%;height:100%;"></iframe>	
		</div>
		<div class="excel">
					...
					<tbody id="content">
						<?php 
							foreach ($result as $value) {
								...
								echo "<td align='center'>".$value['starttimes']."</td>";
...
$(document).ready(function(){
	$('a.infoDetail').live('click',function(){
		...
		if($(this).text() == '查看'){
			...
			$(this).parents('tr').after("<tr id='userdetail-frame'><td colspan='13' style='height:500px; padding:10px; background:#ddd;'><iframe src='<?php echo site_url() ?>/onlineanaly/starttimes/showdetail?date="+date+"'  frameborder='0' scrolling='no' style='width:100%;height:100%;'></iframe></td></tr>");
		}
		else{
			$(this).text('查看');
		}
